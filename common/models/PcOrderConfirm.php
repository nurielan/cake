...
/**
 * This is the model class for table "pc_order_confirm".
 *
 * @property string $id
 * @property string $via
 * @property int $amount
 ...
 */
class PcOrderConfirm extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return $this->hasOne(PcOrderList::className(), ['transfer_confirmation' => 'id']);
    }
}
