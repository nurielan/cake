...
class ProductCategorySearch extends ProductCategory
{
    ...
    public function rules()
    {
        return [
            [['id', 'discount'], 'integer'],
            [['no', 'product_brand_no', 'name', 'alias', 'image1', 'image2', 'image3', 'description', 'status', 'created_at', 'updated_at'], 'safe'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'no', $this->no])
            ->andFilterWhere(['like', 'product_brand_no', $this->product_brand_no])
