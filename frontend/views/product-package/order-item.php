    ...
    <div class="container">
                                    ...
                                    <table class="table table-condensed table-striped table-hover">
                                        ...
                                        <?php foreach ($orderItem as $key => $value): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?= Html::a($value->product_package_name, ['product/detail', 'alias' => $value->product_package_alias], ['target' => '_blank']) ?>
                                                </td>
                                                <td align="center">
                                                    <?= $value->quantity ?>
                                                </td>
                                                <td align="right">
                                                    Rp. <?= number_format($value->product_package_price, 0, '.', ',') ?>
                                                </td>
                                                <td align="right">
        ...
        <div class="row">
            ...
            <div class="col-md-6" align="right">
                <?= Html::a(Yii::t('common', 'Print'), ['product-package/print', 'id' => str_replace('/', '-', $orderList->no)], ['class' => 'btn btn-pink-cake', 'target' => '_blank']) ?>
            </div>
        </div>
    </div>
</section>
