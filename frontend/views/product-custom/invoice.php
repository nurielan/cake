                    ...
                    <table class="table table-striped table-condensed">
                        ...
                        <?php foreach ($model->orderItem as $key => $item): ?>
                            <tr>
                                ...
                                <td valign="middle"><?= $item->product_custom_name ?></td>
                                <td valign="middle" align="center"><?= $item->product_custom_no ?></td>
                                <td valign="middle"><?= Yii::$app->myLibrary->limitText($item->product_custom_description, 20) ?></td>
