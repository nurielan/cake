...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="table-responsive">
            ...
            <p>
                <?= Html::a(Yii::t('common', 'Create Product Category'), ['create'], ['class' => 'btn btn-success']) ?>
            </p>
                    ...
                    [
                        ...
                        'content' => function ($model) {
                            if ($model->productBrand) {
                                $productBrandName = Html::a($model->productBrand->name, ['product-brand/view', 'id' => $model->productBrand->id]);
                            } else {
